...
- `build/report.json`: **1705 / 5933 matched functions** = **28.737568%**
- `matched_code`: **76436 / 993840** = **7.6909766%**
- `tools/gen_objdiff.py`: **1245 linked C TUs / 5442 asm-only units** (**6687 total**)
...
- 25% milestone: **1484 / 5933**, now exceeded by **221** matched functions.
- 26% milestone: **1543 / 5933**; current progress is **1705**, exceeding it by **162** matches.
- Active 27% working goal: **1602 / 5933**; current progress exceeds it by **103** matches.
- Next 30% milestone: **1780 / 5933**; **75** additional matched functions are needed.
