...
- Linked matching metrics remain **1704 / 5934** functions and **76392 / 993840** code because these were already C-linked. The source residue drops from **199 to 196** pin-bearing files and from **772 to 769** compiler pins. Evidence: `.decomp-runs/round-108-screen.json`, `.decomp-runs/round-108-accepted-isolation.json`, and `.decomp-runs/round-108-verify.json`.
