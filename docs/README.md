...
- Verified working tree: `batch 97` — func_08001DFC: array counter loop with BLS branch (u32 counter for unsigned comparison)
- `build/report.json`: **1352 / 5956 matched functions** (**22.6998%**) · **6.4366%** matched code
