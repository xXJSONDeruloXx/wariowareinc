...
- `build/report.json`: **1350 / 5960 matched functions** (**22.6510%**) · **6.457302%** matched code
- `tools/gen_objdiff.py`: **892 linked C TUs / 5795 non-C units**
- `src/decomp/*.c`: **1066 decompiled function files** = **873 standalone_tu** + **193 included_stub**
