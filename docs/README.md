...
- Verified working tree: `batch 224` — twelve compact task/scene/sprite wrappers admitted after a repaired two-pass isolation screen and one complete full-context Docker gate; rejected spellings remain preserved as provenance
- `build/report.json`: **1633 / 5934 matched functions** (**27.519380%**) · **7.313269%** matched code (**72674 / 993728**)
- `tools/gen_objdiff.py`: **1173 linked C TUs / 5514 non-C units** (**6687 total**)
...
- 25% milestone at the current function total: **1484 / 5934**; now exceeded by **149** matches
- 26% milestone at the current function total: **1543 / 5934**; now exceeded by **90** matches
- 27% active working goal at the current function total: **1603 / 5934**; exceeded by **30** matches
- 30% milestone at the current function total: **1781 / 5934**; **148** more matches needed
- 80% target at the current function total: **4748 / 5934**
- Remaining gap to 80%: **3115 matched functions**
