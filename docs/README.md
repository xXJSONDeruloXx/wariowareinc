...
- `build/report.json`: **1407 / 5960 matched functions** (**23.607382%**) · **6.584173%** matched code
...
- 30% milestone at the current function total: **1788 / 5960**; **381** more matches needed
