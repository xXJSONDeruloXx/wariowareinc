...
- `build/report.json`: **1417 / 5960 matched functions** (**23.775167%**) · **6.609311%** matched code
...
- 30% milestone at the current function total: **1788 / 5960**; **371** more matches needed
