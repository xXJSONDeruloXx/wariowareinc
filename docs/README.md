...
- Verified working tree: `batch 201` — twenty-four strict-ROM standalone runtime/scene/graphics helpers across the current sweep, with the known blocked families preserved as provenance
- `build/report.json`: **1517 / 5958 matched functions** (**25.461563%**) · **6.9134383%** matched code (**68694 / 993630**)
- `tools/gen_objdiff.py`: **1057 linked C TUs / 5630 non-C units** (**6687 total**)
...
- 25% milestone at the current function total: **1490 / 5958**; now exceeded by **27** matches
- 30% milestone at the current function total: **1788 / 5958**; **271** more matches needed
- 80% target at the current function total: **4767 / 5958**
- Remaining gap to 80%: **3250 matched functions**
