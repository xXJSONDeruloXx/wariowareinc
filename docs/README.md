...
- `build/report.json`: **1387 / 5960 matched functions** (**23.271812%**) · **6.5387583%** matched code
...
- 30% milestone at the current function total: **1788 / 5960**; **401** more matches needed
- 80% target at the current function total: **4768 / 5960**
- Remaining gap to 80%: **3381 matched functions**
