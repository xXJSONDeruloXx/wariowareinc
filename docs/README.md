...
- Verified working tree: `batch 226` — nine richer stage-unlock predicates admitted from one exact isolation screen and one complete full-context Docker gate
- `build/report.json`: **1657 / 5934 matched functions** (**27.923828%**) · **7.430203%** matched code (**73836 / 993728**)
- `tools/gen_objdiff.py`: **1197 linked C TUs / 5490 non-C units** (**6687 total**)
...
- 25% milestone at the current function total: **1484 / 5934**; now exceeded by **173** matches
- 26% milestone at the current function total: **1543 / 5934**; now exceeded by **114** matches
- 27% active working goal at the current function total: **1603 / 5934**; exceeded by **54** matches
- 30% milestone at the current function total: **1781 / 5934**; **124** more matches needed
