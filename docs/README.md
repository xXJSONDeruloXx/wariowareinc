...
- Verified working tree: `batch 250` — one included-stub ordinary-C main-menu task-spawn helper admitted after a section-level boundary audit plus a host-TU prototype-conflict repair, under the full host-TU Docker gate
...
- `src/decomp/*.c`: **1438 decompiled function files** = **1225 standalone_tu** + **213 included_stub**
