...
- Verified working tree: `batch 251` — one included-stub ordinary-C beatscript task-spawn helper with bitfield-arg struct admitted after an 80-byte section audit, under the full host-TU Docker gate
...
- `src/decomp/*.c`: **1439 decompiled function files** = **1225 standalone_tu** + **214 included_stub**
