...
- Verified working tree: `batch 214` — eight strict-ROM standalone scene-variable, sound/RNG, and indexed-state siblings after the gameplay-wrapper sweep; one near miss remains preserved as provenance
- `build/report.json`: **1573 / 5937 matched functions** (**26.494864%**) · **7.1140604%** matched code (**70690 / 993666**)
- `tools/gen_objdiff.py`: **1113 linked C TUs / 5574 non-C units** (**6687 total**)
...
- 25% milestone at the current function total: **1485 / 5937**; now exceeded by **88** matches
- 26% milestone at the current function total: **1544 / 5937**; now exceeded by **29** matches
- 27% active working goal at the current function total: **1603 / 5937**; **30** more matches needed
- 30% milestone at the current function total: **1782 / 5937**; **209** more matches needed
- 80% target at the current function total: **4750 / 5937**
- Remaining gap to 80%: **3177 matched functions**
