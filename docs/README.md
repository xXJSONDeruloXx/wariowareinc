...
- Verified working tree: `batch 244` — one included-stub ordinary-C sprite helper admitted after an exact symbol-level isolation and the full host-TU Docker gate
