...
- Verified working tree: `batch 225` — fifteen stage-unlock wrappers admitted from one exact isolation screen and one complete full-context Docker gate
- `build/report.json`: **1648 / 5934 matched functions** (**27.772161%**) · **7.374654%** matched code (**73284 / 993728**)
- `tools/gen_objdiff.py`: **1188 linked C TUs / 5499 non-C units** (**6687 total**)
- `src/decomp/*.c`: **1372 decompiled function files** = **1169 standalone_tu** + **203 included_stub**
...
- 25% milestone at the current function total: **1484 / 5934**; now exceeded by **164** matches
- 26% milestone at the current function total: **1543 / 5934**; now exceeded by **105** matches
- 27% active working goal at the current function total: **1603 / 5934**; exceeded by **45** matches
- 30% milestone at the current function total: **1781 / 5934**; **133** more matches needed
- 80% target at the current function total: **4748 / 5934**
- Remaining gap to 80%: **3100 matched functions**
