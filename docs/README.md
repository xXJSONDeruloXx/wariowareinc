...
- Verified working tree: `batch 101` — func_080148BC: main_menu wrapper with RSBS mask-clear + function pointer call
- `build/report.json`: **1356 / 5956 matched functions** (**22.7666%**) · **6.4373%** matched code
