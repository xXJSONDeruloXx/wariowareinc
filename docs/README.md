...
- `build/report.json`: **1485 / 5958 matched functions** (**24.924473%**) · **6.8121023%** matched code
...
- 25% milestone at the current function total: **1490 / 5958**; **5** more matches needed
- 30% milestone at the current function total: **1788 / 5958**; **303** more matches needed
- 80% target at the current function total: **4767 / 5958**
- Remaining gap to 80%: **3282 matched functions**
